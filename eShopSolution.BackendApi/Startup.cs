...
namespace eShopSolution.BackendApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseSqlServer(Configuration.GetConnectionString("eShopSolutionBb")));
            ...
            services.AddTransient<IPublishProductService, PublishProductService>();
            services.AddTransient<IManageProductService, ManageProductService>();
            services.AddTransient<IProductCategoryService, ProductCategoryService>();
            services.AddTransient<ILanguageService, LanguageService>();
            services.AddTransient<IStorageService, FileStorageService>();
            services.AddTransient<IProductImageService, ProductImageService>();
            services.AddTransient<IManageRoleService, ManageRoleService>();
            services.AddTransient<IFunctionService, FunctionService>();
            // Register the Swagger generator, defining 1 or more wSagger documents
